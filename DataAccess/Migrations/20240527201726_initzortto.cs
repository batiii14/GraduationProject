...
{
    /// <inheritdoc />
    public partial class initzortto : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    inMin = table.Column<DateTime>(type: "datetime2", nullable: false),
                    inMax = table.Column<DateTime>(type: "datetime2", nullable: false),
                    outMin = table.Column<DateTime>(type: "datetime2", nullable: false),
                    outMax = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasCleanService = table.Column<bool>(type: "bit", nullable: false),
                    HasShowerAndToilet = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DormitoryDetails", x => x.DetailId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DormitoryOwners", x => x.UserId);
                });
